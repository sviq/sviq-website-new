    ...
    >
      <Container className="space-y-16">
        ...
        <motion.div variants={fadeInUp} className="space-y-3 lg:max-w-4xl">
          <p className={`${fonts.inter} text-sm md:text-base font-medium`}>Our Softwares</p>
          <Heading>Building the foundation for your success with solutions that scale</Heading>
        </motion.div>
