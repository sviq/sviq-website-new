...
export const Connect = ({ productNames }: { productNames: string[] }) => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    formData.append("formType", "productInquiry");
    ...
    <section className="flex justify-center items-center py-8 md:py-14 lg:py-20">
      <Container className="space-y-8">
        <div className="max-w-5xl">
          <Heading>Have Questions? Let's Connect - We're Here to Help!</Heading>
        </div>
